...
class RemitPayee(models.Model):
    ...
    level = models.ForeignKey(Level, null=True, blank=True, related_name='remit_payee_level')
...
class OnlinePayee(models.Model):
    ...
    payment_type = models.ForeignKey(Level, null=True, blank=True, related_name='online_payee_level')
    ...
    merchant_account = models.CharField(max_length=255, null=False, blank=False)
