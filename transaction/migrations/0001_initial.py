    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='online_payee_level', to='level.Level')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='remit_payee_level', to='level.Level')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
